...
class AmazonCounterfactualSchema(BaseModel):
    text: str
    completion: Literal[
...
class AmazonCounterFactual(BaseConfig):
    def __init__(
        self,
        ...
        self.task_name = "amazon_cf"
        register_task_schema(self.task_name, AmazonCounterfactualSchema)

    def build_dataset(self):
        self.dataset = load_dataset("mteb/amazon_counterfactual")
        ...
        self.label_verbalization = {
            "not-counterfactual": "It is not counterfactual",
            "counterfactual": "It is counterfactual",
        }
    ...
    def get_evaluator_config(self):
        return {
            "evaluator+yes": EvaluatorConfig(
                ...
                instruction="""Assess the suitability of this example for a binary classification task that aims to determine whether a text is counterfactual or not counterfactual. The example can only be labeled as either "It is counterfactual" or "It is not counterfactual".
